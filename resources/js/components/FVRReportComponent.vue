    ...
    <div class="main-container p-4">
        ...
        <div class="user-button d-flex justify-content-between pt-3 pb-3">
            <ul class="breadcrumb-1 pl-0 m-0">
                ...
                <li class="d-inline align-middle" style="font-size: 12px; color: #95a5a6">FVR Report</li>
            </ul>
        </div>
        ...
        <div class="main-content">
            <div class="card mt-5" style="width: 600px; margin: 0 auto;">
                ...
                <div class="card-header">
                    <h4 style="font-size: 18px; margin: 0">FVR Reports</h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    <select id="report_type" class="form-control" v-model="report.type" v-on:change="selectChange">
                        <option value="1">Amount Collected Report - (Range)</option>
                    </select>
...
export default {
    ...
    methods: {
        ...
        printPdf() {
            ...
            window.open('fvr_report/pdf/' + this.report.from + '/' + this.report.to + optional_route + '/' + this.paperSize + '/' + this.paperOrientation)
        ...
        exportReport() {
            ...
            let optional_route = this.barangay.id == null || this.barangay.id === '' ? '/null' : '/'  + this.barangay.id;
            window.open('fvr_report/export/' + this.report.from + '/' + this.report.to + optional_route)
        },
